...
require (
	...
	github.com/nodeset-org/hyperdrive-daemon v1.0.2-0.20240826210915-876e58ce4206
	github.com/nodeset-org/nodeset-client-go v0.0.0-20240826205923-b182d063ba2a
