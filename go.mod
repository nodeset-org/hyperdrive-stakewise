...
require (
	...
	github.com/nodeset-org/hyperdrive-daemon v0.4.2-dev.0.20240606193228-1026838938f2
	github.com/rocket-pool/batch-query v1.0.0
	github.com/rocket-pool/node-manager-core v0.3.1-0.20240606192401-338c36a00a9a
