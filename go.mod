...
require (
	...
	github.com/nodeset-org/hyperdrive-daemon v0.4.2-dev.0.20240529192908-cdafb45d88eb
	github.com/rocket-pool/batch-query v1.0.0
	github.com/rocket-pool/node-manager-core v0.3.1-0.20240529192147-051429eb6636
